CREATE TABLE IF NOT EXISTS bad_product_record (
    ...
    responsible_person VARCHAR(80) NULL COMMENT '负责人员',
    process_measure VARCHAR(500) NULL COMMENT '处理措施',
    improvement_plan VARCHAR(500) NULL COMMENT '改进方案',
    attachment_name VARCHAR(180) NULL COMMENT '附件名称',
    attachment_url VARCHAR(512) NULL COMMENT '附件地址',
    attachment_size BIGINT NULL COMMENT '附件大小，字节',
