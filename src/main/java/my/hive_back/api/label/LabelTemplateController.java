...
public class LabelTemplateController {
    ...
    @CollectLog(module = "label_template", action = "mini_save", bizType = "label_template", bizNo = "#request.id", description = "小程序保存标签模板")
    ...
    @CollectLog(module = "label_template", action = "mini_upload", bizType = "label_template", description = "小程序上传标签模板")
    ...
    @CollectLog(module = "label_template", action = "mini_set_default", bizType = "label_template", bizNo = "#id", description = "小程序设置默认标签模板")
    ...
    @CollectLog(module = "label_template", action = "mini_disable", bizType = "label_template", bizNo = "#id", description = "小程序停用标签模板")
