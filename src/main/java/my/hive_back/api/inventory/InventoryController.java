...
@RequireTenantFeature(TenantFeatureEnum.CODE_MODULE_INVENTORY)
@Validated
public class InventoryController {
    ...
    @RequirePermission(value = PermissionCodeEnum.CODE_INVENTORY_BARCODE_SEARCH, message = "您没有权限查询条码")
    ...
    @RequirePermission(value = PermissionCodeEnum.CODE_INVENTORY_MODEL_SEARCH, message = "您没有权限查询型号规格")
    ...
    @RequirePermission(value = PermissionCodeEnum.CODE_INVENTORY_CLOTH_OUT, message = "您没有权限查询出库业务单")
    ...
    @RequirePermission(value = PermissionCodeEnum.CODE_INVENTORY_RECORD_RECENT, message = "您没有权限查看出入库记录")
    ...
    @RequirePermission(value = PermissionCodeEnum.CODE_INVENTORY_CLOTH_OUT, message = "您没有权限提交出库打印")
